...
import confetti from './resources/image-confetti.jpg';
  ...
  return (
    <div className="App">
          ...
          <div className="Articles">
            <div className="Article">
              <div className="Article_Image">
                <img alt="currency" src={currency}></img >
              </div>
            ...
            <div className="Article">
              <div className="Article_Image">
                <img alt="confetti" src={confetti}></img >
              </div>
              <div className="Article_Body">
                <div className="Article_Author">
                  By Claire Robinson
        ...
        <div className="Footer">
          <div className="Footer_Left">
            <div className="Footer_Logo">
              <svg xmlns="http://www.w3.org/2000/svg" width="139" height="20"><defs><linearGradient id="a" x1="72.195%" x2="17.503%" y1="0%" y2="100%">
                <stop offset="0%" stopColor="#33D35E" /><stop offset="100%" stopColor="#2AB6D9" /></linearGradient></defs><g fill="none" fillRule="evenodd">
                  <path fill="#FAFAFA" fillRule="nonzero" d="M37.754 15.847c2.852 0 5.152-1.622 5.952-4.216h-3.897c-.376.665-1.14 1.066-2.055 1.066-1.237 0-2.065-.674-2.32-1.978h8.44c
          .051-.352.081-.694.081-1.037 0-3.335-2.537-5.95-6.201-5.95-3.568 0-6.175 2.564-6.175 6.049 0 3.473 2.628 6.066 6.175 6.066zm2.344-7.297h-4.596c.317-1.129 1.11-1.749 2.252-1.749
           1.181 0 2 .613 2.344 1.75zm10.946 7.296c1.32 0 2.5-.434 3.43-1.188l.336.804h3.027V4.093h-2.919l-.4.88c-.94-.775-2.135-1.222-3.474-1.222-3.476 0-5.961 2.505-5.961 6.026 0 3.533
            2.485 6.07 5.961 6.07zm.524-3.467c-1.467 0-2.545-1.108-2.545-2.593 0-1.475 1.069-2.583 2.545-2.583 1.466 0 2.544 1.108 2.544 2.583 0 1.485-1.078 2.593-2.544 2.593zm13.123 3.467c3.02
             0 5.025-1.554 5.025-3.93 0-2.883-2.387-3.256-4.183-3.575-1.08-.193-1.95-.344-1.95-.99 0-.527.422-.838 1.05-.838.71 0 1.197.337 1.197 1.063h3.667c-.044-2.303-1.92-3.843-4.816-3.843-2.912
              ...
              <a href="https://es-la.facebook.com/" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"> <defs>
                  <linearGradient id="gradient">
                    <stop offset="10%" stop-color="#31d35c" />
                    <stop offset="100%" stop-color="#2bb7da" />
                  </linearGradient>
                </defs>
      ...
      {isTabletOrMobile && <>
        ...
        {
          Open && (<><div className='Routes'>
            {
              Menu.map((item) => (
                <li key={item} className="Route">{item}</li>
              ))
            }
